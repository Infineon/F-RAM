...
* The function sends the memory write 0x02 command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function writes data to the external memory in the single mode. 
* The function sends the special sector write 0x42 command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function writes data to the external memory in the single mode. 
* The function sends the serial number 0xC2 command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function reads data from the external memory in the single mode. 
* The function sends the FAST READ 0x0B command to the external memory. 
...
* The function sends the WREN 0x9F command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function reads device ID from the external FRAM
* The function sends the WREN 0x4C command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function reads device ID from the external FRAM
* The function sends the WREN 0xC3 command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function reads device ID from the external FRAM
* The function sends the WREN 0x4B command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function disables the Write enable bit in the status register. 
* The function sends the WREN 0xB9 command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
...
*
* This function disables the Write enable bit in the status register. 
* The function sends the WREN 0xBA command to the external memory.
*
* \param baseaddr
* Holds the base address of the SMIF block registers.
*
